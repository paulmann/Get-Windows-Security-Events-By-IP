...
- [🎯 Key Use Cases](#-key-use-cases)
  - [Abuse Reporting & Incident Response](#abuse-reporting--incident-response)
  - [Security Operations Center (SOC)](#security-operations-center-soc)
  - [Compliance & Auditing](#compliance--auditing)
  - [Network Security](#network-security)
- [🚀 Features](#-features)
  - [🔍 Advanced Event Correlation & Analysis](#-advanced-event-correlation--analysis)
  - [📊 Comprehensive Security Event Coverage](#-comprehensive-security-event-coverage)
  - [🎨 Flexible Output & Enterprise Reporting](#-flexible-output--enterprise-reporting)
...
- [📥 Installation & Usage](#-installation--usage)
  ...
  - [Usage Examples](#usage-examples)
    - [Basic IP Investigation](#-basic-ip-investigation)
    - [Time-Based Investigations](#-time-based-investigations)
    - [Comprehensive Security Analysis](#-comprehensive-security-analysis)
    - [Advanced Output Configuration](#-advanced-output-configuration)
    - [Incident Response Scenarios](#-incident-response-scenarios)
    - [Automation & Scheduling](#-automation--scheduling)
    - [Troubleshooting & Debugging](#-troubleshooting--debugging)
- [🔧 Parameters](#-parameters)
  - [🎯 Core Query Parameters](#-core-query-parameters)
  - [⏰ Time Filtering Parameters](#-time-filtering-parameters)
  - [📊 Output Control Parameters](#-output-control-parameters)
  - [🔍 Event Processing Parameters](#-event-processing-parameters)
  - [📋 Available Columns](#-available-columns)
  - [🎪 Category-Specific Events](#-category-specific-events)
  - [💡 Usage Examples](#-usage-examples)
- [🔗 DevOps & Automation Integration](#-devops--automation-integration)
  ...
  - [Container & Cloud Integration](#container--cloud-integration)
  - [Monitoring & Alerting Integration](#monitoring--alerting-integration)
...
- [📊 Advanced Security Scenarios](#-advanced-security-scenarios)
  - [🎯 Threat Hunting & Attack Pattern Detection](#-threat-hunting--attack-pattern-detection)
  - [🔄 Incident Response Workflows](#-incident-response-workflows)
  - [🕵️ Advanced Attack Pattern Recognition](#️-advanced-attack-pattern-recognition)
  - [📈 Security Metrics & Compliance Reporting](#-security-metrics--compliance-reporting)
- [🛡️ Security Considerations](#️-security-considerations)
- [🔍 Troubleshooting](#-troubleshooting)
  - [🚀 Common Installation Issues](#-common-installation-issues)
  - [⚠️ Runtime Issues](#-runtime-issues)
  - [🔧 Event Log Access Problems](#-event-log-access-problems)
